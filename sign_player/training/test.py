...
def test(data_loader, agent, model, args):
    sum_reward = 0
    ...
    not_done_all = torch.zeros(args.batch_size * 10).float()
    ...
    log.info("[TEST] attack success rate: {a}, total reward {r}".format(r=sum_reward / test_data_size,
                                                                      a=attack_success_rate))
