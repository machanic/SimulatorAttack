...
def wideresnet28(in_channels, num_classes):
    return WideResNet(28, in_channels, num_classes)

def wideresnet34(in_channels, num_classes):
    return WideResNet(34,in_channels, num_classes)
